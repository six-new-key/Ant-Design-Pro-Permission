        ...
        setup(props,context){
            ...
            let secretKey = ref(''),           //后端返回的ase加密秘钥
                    ...
                    if (num.value == checkNum.value) {
                        ...
                        setTimeout(() => {
                            ...
                            reqCheck(data).then(res=>{
                                if (res.repCode == "0000") {
                                    barAreaColor.value = 'var(--color-success)'
                                    barAreaBorderColor.value = 'var(--color-success)'
                                    text.value = '验证成功'
                                    ...
                                    barAreaColor.value = 'var(--color-error)'
                                    barAreaBorderColor.value = 'var(--color-error)'
                                    text.value = '验证失败'
                                    setTimeout(() => {
                                        refresh();
                                    }, 700);
                ...
                const refresh = function () {
                    ...
                    barAreaColor.value = 'var(--color-text)'
                    barAreaBorderColor.value = 'var(--color-border)'
