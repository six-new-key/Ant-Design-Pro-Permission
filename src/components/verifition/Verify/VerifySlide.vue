    ...
    export default {
        ...
        setup(props,context){
            ...
            let secretKey = ref(''),           //后端返回的ase加密秘钥
                ...
                leftBarBorderColor = ref('var(--color-border)'),
                ...
                function start(e) {
                    ...
                    if (isEnd.value == false) {
                        ...
                        iconColor.value = 'var(--color-bg-container)'
                        e.stopPropagation();
                        status.value = true;
                    }
                }
                    ...
                    if (status.value && isEnd.value == false) {
                        ...
                        reqCheck(data).then(res=>{
                            if (res.repCode == "0000") {
                                ...
                                moveBlockBackgroundColor.value = 'var(--color-error)'
                                leftBarBorderColor.value = 'var(--color-error)'
                                iconColor.value = 'var(--color-bg-container)'
                ...
                const refresh = ()=>{
                    ...
                    leftBarBorderColor.value = 'var(--color-border)'
                    moveBlockBackgroundColor.value = 'var(--color-bg-container)'
                    iconColor.value = 'var(--color-text)'
